 ...
 */
function Edge(nodeStart, nodeEnd, id, weight){
...
module.exports = function Graph(){
   ...
   * @param {Number} [weight=1] the edge's weight.
   */
  this.addEdge = function(idNodeStart, idNodeEnd, id, weight){
    ...
    if(idNodeStart != null && idNodeEnd != null && id != null){
      ...
      if(this.isNode(idNodeStart) && this.isNode(idNodeEnd)){
        ...
        if(!this.isEdge(id)){
          ...
          var edge = new Edge(this.getNode(idNodeStart), this.getNode(idNodeEnd), id, weight);
